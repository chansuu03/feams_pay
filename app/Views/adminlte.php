...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url()?>/dist/adminlte/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?= base_url()?>/dist/adminlte/css/adminlte.min.css">
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="<?= base_url()?>/dist/adminlte/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?= base_url()?>/dist/adminlte/plugins/daterangepicker/daterangepicker.css">
  <!-- summernote -->
  <link rel="stylesheet" href="<?= base_url()?>/dist/adminlte/plugins/summernote/summernote-bs4.css">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url();?>" class="brand-link">
      <img src="<?= base_url()?>/img/fealogo_outlined.png"
           alt="PUP Logo"
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="#">Data Driven Squad</a>.</strong> All rights
    reserved.
  </footer>
...
<script src="<?= base_url()?>/dist/adminlte/js/demo.js"></script>
<!-- Summernote -->
<script src="<?= base_url()?>/dist/adminlte/plugins/summernote/summernote-bs4.min.js"></script>
<!-- DataTables -->
